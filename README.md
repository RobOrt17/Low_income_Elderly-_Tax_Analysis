...
=SUM(OFFSET(Sheet1!$N$29,0,(ROW($A2)-2)*11,1,4))+SUM(OFFSET(Sheet1!$N$39,0,(ROW($A2)-2)*11,1,4))
ACTIVE

Our Project Questions:

Where are the most low income tax filers?

Low income categories: elderly, with children, in school
